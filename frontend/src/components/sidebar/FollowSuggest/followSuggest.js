...
function FollowSuggest() {
  ...
  return (
    <div className='card-box'>
      ...
      { suggest.map((e=>
      e.nombre === undefined  || e._id === userId || data.following.includes(e._id) ? ("") : (<FollowSuggestCard key= {e.nombre+"_"+e.apellido} avatar={e.avatar} name={e.nombre+" "+e.apellido} job={e.puesto} onClick={()=>{handleFollow(e._id)}} type="follow" following={data.following.includes(e._id)}/> ) 
